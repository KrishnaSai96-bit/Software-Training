...
URL_DATABASE = 'postgresql://postgres:Krishna@localhost/employee_details'
...
#ORM Method
@app.post("/EmployeeDetails/CreateEmployeeDataPostgres_Using_ORM", status_code=status.HTTP_201_CREATED)
async def create_recipe(employeeBO: EmployeeBO, db:db_dependency):
